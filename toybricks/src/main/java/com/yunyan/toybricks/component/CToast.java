...
public class CToast {
    ...
    public static CToast makeText(Context context, CharSequence text, int duration) 
    {
        ...
        mLayout.setBackgroundResource(ResourcesUtils.getDrawable(context, "toybricks_progress_toast_bg"));
         
        int w=(int) (context.getResources().getDisplayMetrics().widthPixels *0.7);
        int h=(int) (context.getResources().getDisplayMetrics().widthPixels *0.3);
